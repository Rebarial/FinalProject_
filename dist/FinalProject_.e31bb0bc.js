...
var checkopenmess = false;
var messbutton = document.getElementById('mess');
...
function addMessageStor(text) {
  ...
  list.insertAdjacentHTML('beforeend', "<p class=\"message-item\" data-key=\"".concat(chat.id, "\">\n            <span>").concat(chat.text, "</span>\n        </p>"));
}
...
form.addEventListener('submit', function (event) {
  ...
  var input = document.querySelector('.typedMessage');
...
//# sourceMappingURL=/FinalProject_.e31bb0bc.js.map